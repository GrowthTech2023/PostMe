...
import 'managesubscription_model.dart';
export 'managesubscription_model.dart';

class ManagesubscriptionWidget extends StatefulWidget {
  const ManagesubscriptionWidget({Key? key}) : super(key: key);

  @override
  _ManagesubscriptionWidgetState createState() =>
                    ...
                    Container(
                      width: valueOrDefault<double>(
                        FFAppState().closesidebar
                            ? (MediaQuery.sizeOf(context).width * 0.9492)
                            : (MediaQuery.sizeOf(context).width * 0.7891),
                        1010.0,
                      ),
                      height: MediaQuery.sizeOf(context).height * 1.0,
                      decoration: BoxDecoration(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Align(
                                          ...
                                          child: Text(
                                            'If you need help, \nreach out on social media, email, or\nsubmit a message.',
